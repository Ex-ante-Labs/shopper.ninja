/*1472046660,,JIT Construction: v2523979,en_US*/
...
try {
    ...
    for (var i = 0; i < sandboxWhitelist.length; i++) {
      ...
      with(this) {
        ...
        __d("JSSDKXDConfig", [], {
          ...
          "XdBundleUrl": "\/connect\/xd_arbiter\/r\/uN4_cXtJDGb.js?version=42",
          "Flash": {
        ...
        __d('URISchemes', ['createObjectFrom'], function a(b, c, d, e, f, g, h) {
          if (c.__markCompiled) c.__markCompiled();
          var i = h(['blob', 'cmms', 'fb', 'fbatwork', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite', 'chrome-extension']),
            j = {
        ...
        __d('URIBase', ['URIRFC3986', 'URISchemes', 'ex', 'invariant', 'setHostSubdomain'], function a(b, c, d, e, f, g, h, i, j, k, l) {
          ...
          q.prototype.addQueryData = function(r, s) {
            ...
            if (Object.prototype.toString.call(r) === '[object Object]') {
              ES('Object', 'assign', false, this.$URIBase7, r);
            } else this.$URIBase7[r] = s;
            return this;
          };
          ...
          q.prototype.removeQueryData = function(r) {
            ...
            for (var s = 0, t = r.length; s < t; ++s) delete this.$URIBase7[r[s]];
            return this;
          };
          ...
          q.prototype.$URIBase9 = function() {
            ...
            var w = this.$URIBase8.serialize(this.getQueryData());
            if (w) r += '?' + w;
          ...
          q.prototype.getQualifiedURIBase = function() {
            'use strict';
            return new q(this, this.$URIBase8).qualify();
          };
          q.prototype.qualify = function() {
            'use strict';
            if (!this.getDomain()) {
              var r = new q(window.location.href, this.$URIBase8);
        ...
        __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
          ...
          function ka(ua, va, wa, xa) {
            ...
            var za = {
              ...
              ab = {},
              bb = wa.access_token || v;
            if (bb) ab.access_token = bb;
            if (wa.routing_control) ab.routing_control = wa.routing_control;
            var cb = ES('Object', 'keys', false, ab);
            if (cb.length > 0) {
              ua = p.appendToUrl(ua, ab);
              ES(cb, 'forEach', true, function(hb) {
                return delete wa[hb];
              });
            }
            var db;
            ...
            for (var eb = 0; eb < db.length; eb++) {
              var fb = za[db[eb]],
                gb = ES('Object', 'assign', false, {}, wa);
              if (fb.execute(ua, va, gb, xa)) return;
            }
            xa({
              error: {
                type: 'no-transport',
          ...
          var sa = ES('Object', 'assign', false, new o(), {
            setAccessToken: function ua(va) {
              v = va;
            },
            setAccessTokenForClientID: function ua(va, wa) {
              if (!(v && w && w !== wa)) v = va;
            },
            getAccessToken: function ua() {
              return v;
            },
            setClientID: function ua(va) {
              w = va;
            },
            setDefaultParams: function ua(va) {
              x = va;
            },
            setDefaultTransports: function ua(va) {
              ba = va;
            },
            setMaxConcurrentRequests: function ua(va) {
              ha = va;
            },
            getCurrentlyExecutingRequestCount: function ua() {
              return fa;
            },
            getQueuedRequestCount: function ua() {
              return ga.length;
            },
            rest: ra,
            graph: na,
        ...
        __d('legacy:fb.appevents', ['Assert', 'sdk.AppEvents', 'FB', 'sdk.feature', 'sdk.Runtime'], function a(b, c, d, e, f, g, h, i, j, k, l) {
          ...
          j.provide('AppEvents', {
            logEvent: function m(n, o, p) {
              ...
              h.isString(n, 'Invalid eventName');
              h.maybeNumber(o, 'Invalid valueToSum');
              h.maybeObject(p, 'Invalid params');
              var q = l.getClientID();
              h.isTrue(q !== null && q.length > 0, 'You need to call FB.init() with App ID first.');
              i.logEvent(q, n, o, p);
            },
            logPurchase: function m(n, o, p) {
              h.isTrue(k('allow_non_canvas_app_events', false) || l.isCanvasEnvironment(), 'You can only use this function in Facebook Canvas environment');
              h.isNumber(n, 'Invalid purchaseAmount');
              h.isString(o, 'Invalid currency');
              h.maybeObject(p, 'Invalid params');
              var q = l.getClientID();
              h.isTrue(q !== null && q.length > 0, 'You need to call FB.init() with App ID first.');
              i.logPurchase(q, n, o, p);
            },
            activateApp: function m() {
              h.isTrue(k('allow_non_canvas_app_events', false) || l.isCanvasEnvironment(), 'You can only use this function in Facebook Canvas environment');
              var n = l.getClientID();
              h.isTrue(n !== null && n.length > 0, 'You need to call FB.init() with App ID first.');
              i.activateApp(n);
            },
        ...
        __d('sdk.XFBML.Save', ['sdk.Content', 'sdk.DialogUtils', 'sdk.DOM', 'sdk.Event', 'IframePlugin', 'QueryString', 'sdk.UA', 'sdk.XD', 'sdk.createIframe'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
          ...
          if (c.__markCompiled) c.__markCompiled();
          var q = l.extend({
            constructor: function r(s, t, u, v) {
              this.parent(s, t, u, v);
              var w = n.mobile();
              this.subscribe('xd.savePluginGetBlankIframe', ES(function(x) {
                var y = void 0,
                  z = void 0,
                  aa = void 0,
                  ba = function ga(ha) {
                    if (ha) j.removeCss(ha, 'fb_invisible');
                  },
                  ca = function ga(ha) {
                    if (ha) j.addCss(ha, 'fb_invisible');
                  };
                if (w) {
                  y = i.setupNewDarkOverlay();
                  ca(y);
                  h.append(y);
                  i.addDoubleClickAction(y, function() {
                    return ES(aa, 'forEach', true, ca);
                  }, 5000);
                }
                z = this.setupNewIframeDialog(ES('JSON', 'parse', false, x.data), x.fromIframe, ES('JSON', 'parse', false, x.isHTTPS));
                ca(z);
                h.append(z);
                aa = [z, y];
                var da = function ga() {
                    ES(aa, 'forEach', true, ca);
                    i.onDialogHideCleanup(w);
                  },
                  ea = void 0;
                this.subscribe('xd.savePluginShowIframe', ES(function() {
                  k.fire('savePlugin:hideDialog');
                  ES(aa, 'forEach', true, ba);
                  this.positionOnScreen(z, y);
                  if (!w && !ea) ea = i.addIdleDesktopAction(z, da, 7000);
                }, 'bind', true, this));
                ...
                var fa = setInterval(function() {
                  var ga = document.getElementsByName(x.fromIframe);
                  if (ga.length === 0) {
                    clearTimeout(fa);
                    da();
                    ES(aa, 'forEach', true, function(ha) {
                      ha && ha.parentNode.removeChild(ha);
                    });
                  }
                }, 500);
              }, 'bind', true, this));
            },
            positionOnScreen: function r(s, t) {
              var u, v = n.mobile();
              if (v) {
                (function() {
                  var w = function x(y, z) {
                    if (z != null) i.setDialogPositionToCenter(z, v);
                    i.setDialogPositionToCenter(y, v);
                  };
                  w(s, t);
                  i.addMobileOrientationChangeAction(function(x) {
                    w(s, t);
                  });
                ...
                j.setStyle(s, 'position', 'fixed');
                j.setStyle(s, 'top', '20px');
                j.setStyle(s, 'right', '20px');
              }
            },
            setupNewIframeDialog: function r(s, t, u) {
              var v = '#' + m.encode({
                  forIframe: t
                }),
                w = i.setupNewDialog();
              p({
                url: o.getXDArbiterURL(u) + v,
                name: 'blank_' + this._iframeOptions.name,
                root: w.contentRoot,
                tabindex: -1
              });
              j.addCss(w.contentRoot, 'fb_dialog_iframe');
              ES('Object', 'assign', false, w.dialogElement.style, s.style || {});
              j.setStyle(w.dialogElement, 'width', s.width + 'px');
              j.setStyle(w.dialogElement, 'height', s.height + 'px');
              ES(s.classList, 'forEach', true, function(x) {
                return j.addCss(w.dialogElement, x);
              });
              j.removeCss(w.dialogElement, 'fb_dialog_advanced');
              return w.dialogElement;
            },
  ...
  new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2523979","namespace":"FB","message":"' + e.message + '"}}');
}
